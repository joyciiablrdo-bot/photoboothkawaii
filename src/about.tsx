      ...
      <div className="about-page">
        ...
        <header className="site-header">
          ...
          <Link to="/" className="logo">
            <span className="logo-top">🎀 photobooth 🎀</span>
        ...
        <main>
          <div className="jam-spread-wrap">
            ...
            <div className="jam-seed" style={{ top: "12%", left: "90%", transform: "rotate(28deg)" }} />
            <div className="jam-seed" style={{ top: "48%", left: "92%", transform: "rotate(-12deg)" }} />
            <div className="jam-seed" style={{ top: "72%", left: "88%", transform: "rotate(40deg)" }} />
            ...
            <div className="about-content">
              ...
              <div className="jam-card">
                <h2 className="card-heading"><span className="icon">💖</span> Our Story</h2>
              ...
              <div className="jam-card">
                <h2 className="card-heading"><span className="icon">🎀</span> What Makes It Special</h2>
                <p className="card-text">
              ...
              <div className="jam-card">
                <h2 className="card-heading"><span className="icon">🌸</span> Made for Every Kind of Moment</h2>
                <p className="card-text">
              ...
              {/* OUR GOAL */}
              <div className="jam-card">
                <h2 className="card-heading"><span className="icon">✨</span> Our Goal</h2>
                <p className="card-text">
              ...
              <div className="cta-row">
                ...
                <Link to="/frames"     className="cta-btn cta-btn-secondary">🎀 Browse Frames</Link>
              </div>
