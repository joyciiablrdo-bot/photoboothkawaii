...
export default function ChooseStyle() {
  ...
  return (
    <>
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Baloo+2:wght@700;800&family=Nunito:wght@400;600;700&family=Fredoka:wght@600;700&display=swap"
        rel="stylesheet"
      />
      ...
      <div className="bg-floats" aria-hidden="true">
        <svg className="f1" width="56" height="42" viewBox="0 0 64 48">
          <ellipse cx="32" cy="28" rx="28" ry="16" fill="#fff" stroke="#c9b8e8" strokeWidth="2" />
          <circle cx="22" cy="18" r="3" fill="#4a3728" />
          <circle cx="42" cy="18" r="3" fill="#4a3728" />
          <path d="M26 30 Q32 36 38 30" stroke="#4a3728" strokeWidth="2" fill="none" strokeLinecap="round" />
        </svg>
        <svg className="f2" viewBox="0 0 48 48">
          <polygon points="24,4 30,18 46,18 34,28 38,44 24,36 10,44 14,28 2,18 18,18" fill="#ffe066" stroke="#f0c040" strokeWidth="2" />
          <circle cx="18" cy="22" r="2.5" fill="#4a3728" />
          <circle cx="28" cy="22" r="2.5" fill="#4a3728" />
        </svg>
        <svg className="f3" viewBox="0 0 44 44">
          <circle cx="22" cy="22" r="18" fill="#ffb8d9" stroke="#ff8cc8" strokeWidth="2" />
          <circle cx="16" cy="18" r="2" fill="#4a3728" />
          <circle cx="28" cy="18" r="2" fill="#4a3728" />
          <text x="22" y="30" textAnchor="middle" fontSize="10" fill="#ff6ba8">✿</text>
        </svg>
        <svg className="f4" viewBox="0 0 40 40">
          <text x="20" y="28" textAnchor="middle" fontSize="24">💕</text>
        </svg>
      </div>
      ...
      <header className="site-header">
        ...
        <nav className={`site-nav${menuOpen ? " open" : ""}`} aria-label="Main">
          <ul className="nav-main">
            ...
            <li>
              <Link to="/photobooth" className="active" onClick={() => setMenuOpen(false)}>
                Photobooth
              </Link>
            </li>
      ...
      <main>
        ...
        <h1 className="page-heading">🎀 Choose Your Photo Style</h1>
        <p className="page-sub">Pick a style to start your kawaii photobooth session ♡</p>

        <div className="style-grid">

          {/* Polaroid → /booth/polaroid */}
          <Link to="/booth/polaroid" className="style-card">
            <div className="card-visual">
              <div className="visual-polaroid">
                <div className="p-img">🌸</div>
                <div className="p-label">my cute selfie ♡</div>
              </div>
              <span className="card-badge">1 SHOT</span>
            </div>
            <div className="card-title">Polaroid Frame</div>
            <p className="card-desc">
              One perfect snapshot styled inside a beautiful polaroid with 50+ kawaii frame designs.
            </p>
            <span className="card-tag">✨ Single Shot</span>
          </Link>

          {/* Photostrip → /booth/strip */}
          <Link to="/booth/strip" className="style-card">
            <div className="card-visual">
              <div className="visual-strip">
                <div className="s-cell" style={{ background: "linear-gradient(135deg,#ffe8f4,#f0d4ff)" }}>🌷</div>
                <div className="s-cell" style={{ background: "linear-gradient(135deg,#d4f0ff,#e8f4ff)" }}>🦋</div>
                <div className="s-cell" style={{ background: "linear-gradient(135deg,#fff4d4,#ffe8b4)" }}>🌻</div>
                <div className="s-cell" style={{ background: "linear-gradient(135deg,#e8ffd4,#d4f0e8)" }}>🍀</div>
              </div>
              <span className="card-badge">4 SHOTS</span>
            </div>
            <div className="card-title">4 Vertical Photostrip</div>
            <p className="card-desc">
              Four back-to-back poses combined into one retro-style vertical strip with 50+ frame designs.
            </p>
            <span className="card-tag">🎞️ Photo Strip</span>
          </Link>
